...
| Tests | 29 runs, 141 assertions; Minitest throughout |
...
- Pagination with Pagy on blog index and category pages (default: 12 per page)
...
- Wire `Seoable` concern to output `<title>`, `<meta name="description">`, canonical `<link>`
